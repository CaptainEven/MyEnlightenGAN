...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--display_freq',
                                 type=int,
                                 default=10,
        ...
        self.parser.add_argument('--niter_decay',
                                 type=int,
                                 default=100,
        ...
        self.parser.add_argument('--no_lsgan',
                                 action='store_true',
